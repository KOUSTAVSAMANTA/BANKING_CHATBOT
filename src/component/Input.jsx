  ...
  const handleSend = () =>{
    ...
    if(img){
      console.log(img)
        ...
        else if (_z === "enter your phone number" && flag===true && isNaN(val)===false)
            // else if(val.includes("-ac"))
        {
                let ch = st['msg'][st['user']]['chat']
                ch.push({from:'our',msag:val});
        ...
        else if (_z === "enter your phone number" && flag===true && isNaN(val)===true)
            // else if(val.includes("-ac"))
        {
                let ch = st['msg'][st['user']]['chat']
                ch.push({from:'our',msag:val});
...
//   let active = false
  ...
  return (
    <div className='input'>
      ...
      {/* <button onClick={handleaudiostart}>Start</button>
      <button onClick={handleaudio}>Stop</button>
